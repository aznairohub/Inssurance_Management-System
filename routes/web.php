...
Route::get('/firstform',[usercontroller::class,'firstform']);
Route::post('/firstformaction',[usercontroller::class,'firstformaction']);
Route::get('viewfirstform',[usercontroller::class,'viewfirstform']);
